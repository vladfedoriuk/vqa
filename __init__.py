"""
The package for experiments with the VQA models.
...
- :mod:`.pipelines` - The pipelines for the experiments (data processing).
- :mod:`.scripts` - The scripts for the experiments (the bash scripts).
- :mod:`.transforms` - The transforms for the experiments (data augmentation).
- :mod:`.utils` - The utilities for the experiments (e.g. the answer space).
"""
